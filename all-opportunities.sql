-- Delete existing solar panel opportunities and recreate all 103 from Excel
DELETE FROM degoudse.opportunities WHERE title = 'Zonnepanelen';
...
INSERT INTO degoudse.opportunities (
  ...
  'Zonnepanelen',
  (SELECT id FROM degoudse.customers WHERE name = 'RGO Makelaars B.V.' LIMIT 1),
  1,
...
INSERT INTO degoudse.opportunities (
  ...
  'Zonnepanelen',
  (SELECT id FROM degoudse.customers WHERE name = 'Tex-Mex Streetfood' LIMIT 1),
  1,
  (SELECT id FROM degoudse.customers WHERE name = 'Schouten Zekerheid Mak in Ass BV' LIMIT 1),
  (SELECT id FROM degoudse.users WHERE name = 'Albrecht Bouwman'),
...
INSERT INTO degoudse.opportunities (
  ...
  'Zonnepanelen',
  (SELECT id FROM degoudse.customers WHERE name = 'Vishandel sperling' LIMIT 1),
  1,
  (SELECT id FROM degoudse.customers WHERE name = 'Schouten Zekerheid Mak in Ass BV' LIMIT 1),
  (SELECT id FROM degoudse.users WHERE name = 'Albrecht Bouwman'),
...
INSERT INTO degoudse.opportunities (
  ...
  'Zonnepanelen',
  (SELECT id FROM degoudse.customers WHERE name = 'TOPHOLD International B.V.' LIMIT 1),
  1,
  (SELECT id FROM degoudse.customers WHERE name = 'Schouten Zekerheid Mak in Ass BV' LIMIT 1),
  (SELECT id FROM degoudse.users WHERE name = 'Albrecht Bouwman'),
