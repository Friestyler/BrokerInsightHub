...
- June 24, 2025: Updated target group selection cards in campaign builder to match data upload entity selection UX exactly - applied #E6E7F1 border color, authentic hover:shadow-md transition-shadow effects, restored border-2 thickness, and removed selection confirmation section below cards for clean, consistent user experience across platform.
