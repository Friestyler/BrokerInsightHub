...
- June 24, 2025: Updated target group selection cards in campaign builder to use standardized #E6E7F1 border color and applied consistent hover effects matching data upload entity selection cards - changed from border-gray-200 to border-[#E6E7F1], added hover:bg-[#E6E7F1] background, maintained all selection states and visual feedback for unified user experience across platform.
