...
- June 26, 2025: Removed outside borders from category management cards - updated Card components to use border-none instead of border-[#E6E7F1] for cleaner, borderless interface while maintaining internal visual hierarchy through hover states and background colors.
