...
import PartnerListsRedesign from "@/pages/lists/PartnerListsRedesign";
  ...
  return (
    <Layout>
      <Switch>
        ...
        <Route path="/lists/partners" component={PartnerListsRedesign} />
        <Route path="/lists/partners-old" component={PartnersPage} />
