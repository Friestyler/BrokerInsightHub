...
import { Eye, Search, Users, Calendar, Target, ExternalLink } from 'lucide-react';
...
export default function BrokerCampaignsPage() {
  const [searchTerm, setSearchTerm] = useState('');

  // Fetch campaigns shared with Regional Insurance Partners
    ...
    <BrokerLayout>
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600">
          Campaigns shared with Regional Insurance Partners by De Goudse Insurance
        </p>
      </div>
        ...
        <Card>
          <CardContent className="p-12 text-center">
            ...
            <p className="text-gray-600 mb-4">
              No campaigns have been shared with Regional Insurance Partners yet.
            </p>
            <p className="text-sm text-gray-500">
              Contact De Goudse Insurance to request access to relevant campaign templates.
            </p>
          </CardContent>
        </Card>
      ) : (
                ...
                <div className="space-y-3">
                  ...
                  {campaign.sponsorName && (
                    <div className="flex items-center justify-between text-sm">
                      ...
                      <span className="font-medium text-[#282A3F]">{campaign.sponsorName}</span>
                    </div>
                  )}
