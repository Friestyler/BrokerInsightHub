          ...
          <div className="space-y-4">
            ...
            <div className="bg-blue-50 p-3 rounded-md">
              <p className="text-sm text-blue-800">
                {selectedPartners.length} partner{selectedPartners.length !== 1 ? 's' : ''} will be added to this list.
              </p>
            </div>
          </div>
          <DialogFooter>
      ...
      <Dialog open={showAddToCampaignModal} onOpenChange={setShowAddToCampaignModal}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              Add selected partners to an existing campaign or create a new one.
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-4">
            <div className="space-y-3">
            ...
            <div className="bg-blue-50 p-3 rounded-md">
              <p className="text-sm text-blue-800">
                {selectedPartners.length} partner{selectedPartners.length !== 1 ? 's' : ''} will be added to this campaign.
              </p>
            </div>
          </div>
          <DialogFooter>
      ...
      <Dialog open={showAssignTemplateModal} onOpenChange={setShowAssignTemplateModal}>
        <DialogContent className="sm:max-w-2xl">
          <DialogHeader>
            ...
            <DialogDescription>
              Select OKR templates to assign to {selectedPartners.length} selected partner{selectedPartners.length !== 1 ? 's' : ''}. Templates will be converted to active OKRs with tracking capabilities.
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="space-y-4">
            <div className="bg-blue-50 p-3 rounded-md">
              ...
              <p className="text-xs text-blue-600 mt-1">
                Willis B.V, Regional Insurance Partners, Independent Insurance Advisors, and {selectedPartners.length - 3} more...
              </p>
            </div>
            ...
            <div>
              <div className="flex items-center justify-between mb-3">
                ...
                <span className="text-sm text-gray-500">0 of 16 selected</span>
              </div>
              ...
              <div className="space-y-3 max-h-60 overflow-y-auto">
                <div>
                  <Badge variant="secondary" className="mb-2">Customer Satisfaction (1)</Badge>
                  <div className="border rounded-lg p-3">
                    <div className="flex items-center space-x-2 mb-2">
                      <Checkbox id="customer-retention" />
                      <div className="flex-1">
                        <Label htmlFor="customer-retention" className="font-medium">Customer Retention Rate</Label>
                        <Badge variant="outline" className="ml-2 text-xs">activity</Badge>
                      </div>
                    </div>
                    <p className="text-sm text-gray-600 ml-6">Percentage of customers retained</p>
                    <p className="text-xs text-gray-500 ml-6">🎯 95% none</p>
                  </div>
                </div>
                
                <div>
                  <Badge variant="secondary" className="mb-2 bg-orange-100 text-orange-800">Operational Efficiency (1)</Badge>
                  <div className="border rounded-lg p-3">
                    <div className="flex items-center space-x-2 mb-2">
                      <Checkbox id="claims-processing" />
                      <div className="flex-1">
                        <Label htmlFor="claims-processing" className="font-medium">Claims Processing Time</Label>
                        <Badge variant="outline" className="ml-2 text-xs">activity</Badge>
                      </div>
                    </div>
                    <p className="text-sm text-gray-600 ml-6">Average time to process claims in days</p>
                    <p className="text-xs text-gray-500 ml-6">📊 5.4 none</p>
                  </div>
                </div>
              </div>
            </div>
