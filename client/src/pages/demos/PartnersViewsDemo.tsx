        ...
        <CardContent className="p-6">
          <div className="space-y-6">
            ...
            <div className="flex flex-col space-y-4">
              ...
              {/* List Selector - only show if not in quickswitcher or salesforce mode */}
              {selectedViewStyle !== 'quickswitcher' && selectedViewStyle !== 'salesforce' && (
              ...
              {selectedViewStyle === 'salesforce' && (
                <div className="mb-4">
                  <div className="bg-white border border-gray-200 rounded-md mb-4">
                    <div className="bg-gray-50 p-3 border-b border-gray-200 flex flex-wrap justify-between items-center gap-y-2">
                      <div className="flex items-center gap-4">
                        ...
                        <div className="relative">
                          <select
                            className="appearance-none bg-blue-600 text-white pl-3 pr-8 py-2 text-sm font-medium border border-blue-700 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-800 focus:border-blue-800 min-w-[200px]"
                            value={activeViewId}
                    ...
                    {/* Active filters summary */}
                    {activeView && (
                      <div className="p-3 flex flex-wrap items-center text-sm">
                        <div className="text-gray-500 mr-2">Showing:</div>
                        {(activeView.filters.status || activeView.filters.industry || activeView.filters.type) ? (
                          <div className="flex flex-wrap gap-2">
                            {activeView.filters.status && (
                  ...
                  {/* Additional filter bar with search (Salesforce-style) */}
                  <div className="flex flex-wrap gap-4 mb-4">
                    <div className="relative w-[300px]">
                      <input
                        type="text" 
