          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex-1 max-w-md ml-8">
              <div className="flex justify-between items-center relative">
                ...
                {/* Progress Line */}
                <div 
                  className="absolute top-4 left-4 h-0.5 bg-[#5567E5] z-5 transition-all duration-300"
                  style={{ 
                    width: `calc(${((currentStep - 1) / (steps.length - 1)) * 100}% - 16px + ${((currentStep - 1) / (steps.length - 1)) * 16}px)`
                  }}
                />
              </div>
            </div>
