...
export default function NetworkVisualization({ entityType, entityId, entityName }: NetworkVisualizationProps = {}) {
  ...
  const OrgChartContent = () => {
    ...
    const ContactCard = ({ person }: { person: any }) => {
      ...
      return (
        <div 
          className={`p-3 rounded-lg border cursor-pointer hover:shadow-md transition-shadow min-w-[180px] ${getRoleColor(person.level)} relative`}
          style={{ zIndex: 10 }}
          onClick={(e) => {
            e.preventDefault();
            e.stopPropagation();
    ...
    return (
      <div className="relative h-96 bg-gray-50 rounded-lg border overflow-hidden">
        ...
        >
          ...
          <div className="p-6 min-w-fit relative">
